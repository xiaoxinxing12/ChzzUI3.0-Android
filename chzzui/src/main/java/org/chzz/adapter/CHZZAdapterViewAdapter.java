 ...
 * 描述:AdapterView适配器
 */
public abstract class CHZZAdapterViewAdapter<M> extends BaseAdapter {
    ...
    public CHZZAdapterViewAdapter(Context context, int itemLayoutId) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final CHZZAdapterViewHolder viewHolder = CHZZAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
