 ...
 * @param <M> 适配的数据类型
 */
public abstract class CHZZRecyclerViewAdapterOld<M> extends RecyclerView.Adapter<CHZZRecyclerViewHolder> {
    ...
    public CHZZRecyclerViewAdapterOld(RecyclerView recyclerView, int itemLayoutId) {
    ...
    public CHZZRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CHZZRecyclerViewHolder viewHolder = new CHZZRecyclerViewHolder(mRecyclerView, LayoutInflater.from(mContext).inflate(mItemLayoutId, parent, false), mOnRVItemClickListener, mOnRVItemLongClickListener);
     ...
     * @param model
     */
    protected abstract void fillData(CHZZViewHolderHelper helper, int position, M model);
