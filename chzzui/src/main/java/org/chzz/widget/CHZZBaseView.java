...
public class CHZZBaseView {
    ...
    public CHZZBaseView(Context context){
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (onDismissListener != null) {
                            onDismissListener.onDismiss(CHZZBaseView.this);
                        }
                    }
                });
            }
    ...
    public CHZZBaseView setOnDismissListener(OnDismissListener onDismissListener) {
        this.onDismissListener = onDismissListener;
        return this;
    }

    public CHZZBaseView setCancelable(boolean isCancelable) {
