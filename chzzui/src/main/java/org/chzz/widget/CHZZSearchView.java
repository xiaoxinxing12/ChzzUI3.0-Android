...
import org.chzz.R;
import org.chzz.util.AnimationUtil;
 ...
 */
public class CHZZSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public CHZZSearchView(Context context) {
        this(context, null);
    }

    public CHZZSearchView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CHZZSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.CHZZSearchView, defStyleAttr, 0);

        if (a != null) {
            if (a.hasValue(R.styleable.CHZZSearchView_searchBackground)) {
                setBackground(a.getDrawable(R.styleable.CHZZSearchView_searchBackground));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_android_textColor)) {
                setTextColor(a.getColor(R.styleable.CHZZSearchView_android_textColor, 0));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_android_textColorHint)) {
                setHintTextColor(a.getColor(R.styleable.CHZZSearchView_android_textColorHint, 0));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_android_hint)) {
                setHint(a.getString(R.styleable.CHZZSearchView_android_hint));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_searchVoiceIcon)) {
                setVoiceIcon(a.getDrawable(R.styleable.CHZZSearchView_searchVoiceIcon));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_searchCloseIcon)) {
                setCloseIcon(a.getDrawable(R.styleable.CHZZSearchView_searchCloseIcon));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_searchBackIcon)) {
                setBackIcon(a.getDrawable(R.styleable.CHZZSearchView_searchBackIcon));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_searchSuggestionBackground)) {
                setSuggestionBackground(a.getDrawable(R.styleable.CHZZSearchView_searchSuggestionBackground));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_searchSuggestionIcon)) {
                setSuggestionIcon(a.getDrawable(R.styleable.CHZZSearchView_searchSuggestionIcon));
            }

            if (a.hasValue(R.styleable.CHZZSearchView_android_inputType)) {
                setInputType(a.getInt(R.styleable.CHZZSearchView_android_inputType, EditorInfo.TYPE_NULL));
            }
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mUserQuery = s;
                startFilter(s);
                CHZZSearchView.this.onTextChanged(s);
            }
    ...
    private void startFilter(CharSequence s) {
        if (mAdapter != null && mAdapter instanceof Filterable) {
            ((Filterable) mAdapter).getFilter().filter(s, CHZZSearchView.this);
        }
    }
    ...
    public void setCursorDrawable(int drawable) {
        try {
            ...
            Log.e("CHZZSearchView", ignored.toString());
        }
    }
