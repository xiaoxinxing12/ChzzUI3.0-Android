...
public class ChzzImageView extends ImageView {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, org.chzz.R.styleable.ChzzImageView);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == org.chzz.R.styleable.ChzzImageView_android_src) {
            mDefaultImageId = typedArray.getResourceId(attr, 0);
        } else if (attr == org.chzz.R.styleable.ChzzImageView_bga_iv_isCircle) {
            mIsCircle = typedArray.getBoolean(attr, mIsCircle);
        } else if (attr == org.chzz.R.styleable.ChzzImageView_bga_iv_cornerRadius) {
            mCornerRadius = typedArray.getDimensionPixelSize(attr, mCornerRadius);
        } else if (attr == org.chzz.R.styleable.ChzzImageView_bga_iv_isSquare) {
            mIsSquare = typedArray.getBoolean(attr, mIsSquare);
        } else if (attr == org.chzz.R.styleable.ChzzImageView_bga_iv_borderWidth) {
            mBorderWidth = typedArray.getDimensionPixelSize(attr, mBorderWidth);
        } else if (attr == org.chzz.R.styleable.ChzzImageView_bga_iv_borderColor) {
