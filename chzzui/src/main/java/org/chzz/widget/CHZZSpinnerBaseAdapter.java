...
public abstract class CHZZSpinnerBaseAdapter<T> extends BaseAdapter {
    ...
    public CHZZSpinnerBaseAdapter(Context context, int textColor, int backgroundSelector, boolean isCheckBox, onCheckBoxChecked onClickCheckBox) {
        mContext = context;
