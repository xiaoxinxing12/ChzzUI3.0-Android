 ...
 * 创建时间:15/5/21 12:56
 * 描述:继承该抽象类实现响应的抽象方法，做出各种下拉刷新效果。参考CHZZNormalRefreshViewHolder、CHZZStickinessRefreshViewHolder、CHZZMoocStyleRefreshViewHolder、CHZZMeiTuanRefreshViewHolder
 */
public abstract class CHZZRefreshViewHolder {
    ...
    /**
     * 改变整个下拉刷新头部控件移动一定的距离（带动画），自定义刷新控件进入刷新状态前后的高度有变化时可以使用该方法（参考CHZZStickinessRefreshView）
     *
     * @param distance
     */
    ...
    /**
     * 设置下拉刷新上拉加载更多控件，该方法是设置CHZZRefreshViewHolder给CHZZRefreshLayout时由CHZZRefreshLayout调用
     *
     * @param refreshLayout
     */
