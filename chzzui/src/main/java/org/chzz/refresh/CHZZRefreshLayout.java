...
public class CHZZRefreshLayout extends LinearLayout {
     ...
     * 下拉刷新和上拉加载更多代理
     */
    private CHZZRefreshLayoutDelegate mDelegate;
    /**
     * 手指按下时，y轴方向的偏移量
     */
    ...
    private CHZZRefreshScaleDelegate mRefreshScaleDelegate;
    ...
    /**
     * 切换到正在刷新状态，会调用delegate的onCHZZRefreshLayoutBeginRefreshing方法
     */
    public void beginRefreshing() {
        if (mCurrentRefreshStatus != RefreshStatus.REFRESHING && mDelegate != null) {
            ...
            handleRefreshStatusChanged();
            mDelegate.onCHZZRefreshLayoutBeginRefreshing(this);
        }
    }
    ...
    /**
     * 开始上拉加载更多，会触发delegate的onCHZZRefreshLayoutBeginRefreshing方法
     */
    public void beginLoadingMore() {
        if (!mIsLoadingMore && mLoadMoreFooterView != null && mDelegate != null && mDelegate.onCHZZRefreshLayoutBeginLoadingMore(this)) {
            mIsLoadingMore = true;
     ...
     * @param delegate
     */
    public void setDelegate(CHZZRefreshLayoutDelegate delegate) {
        mDelegate = delegate;
    }
     ...
     */
    public void setRefreshScaleDelegate(CHZZRefreshScaleDelegate refreshScaleDelegate) {
    ...
    public interface CHZZRefreshLayoutDelegate {
        /**
         * 开始刷新
         */
        void onCHZZRefreshLayoutBeginRefreshing(CHZZRefreshLayout refreshLayout);
         ...
         */
        boolean onCHZZRefreshLayoutBeginLoadingMore(CHZZRefreshLayout refreshLayout);
    }

    public interface CHZZRefreshScaleDelegate {
        /**
         * 下拉刷新控件可见时，处理上下拉进度
         *
