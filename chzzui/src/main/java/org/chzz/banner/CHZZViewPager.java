 ...
 */
public class CHZZViewPager extends ViewPager {
    private boolean mAllowUserScrollable = true;
    private AutoPlayDelegate mAutoPlayDelegate;

    public CHZZViewPager(Context context) {
        super(context);
    }

    public CHZZViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setPageChangeDuration(int duration) {
        try {
            ...
            scrollerField.set(this, new CHZZBannerScroller(getContext(), duration));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
