...
import org.chzz.R;
import org.chzz.banner.transformer.BGAPageTransformer;
...
public class CHZZBanner extends RelativeLayout implements CHZZViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private CHZZOnNoDoubleClickListener mGuideOnNoDoubleClickListener = new CHZZOnNoDoubleClickListener() {
        @Override
    ...
    public CHZZBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CHZZBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointLeftRightMargin = CHZZBannerUtil.dp2px(context, 3);
        mPointTopBottomMargin = CHZZBannerUtil.dp2px(context, 6);
        mPointContainerLeftRightPadding = CHZZBannerUtil.dp2px(context, 10);
        mTipTextSize = CHZZBannerUtil.sp2px(context, 10);
        mPointContainerBackgroundDrawable = new ColorDrawable(Color.parseColor("#44aaaaaa"));
        mTransitionEffect = TransitionEffect.Default;
        mNumberIndicatorTextSize = CHZZBannerUtil.sp2px(context, 10);

        mContentBottomMargin = 0;
    }

    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CHZZBanner);
    ...
    public void showPlaceholder() {
        if (mPlaceholderIv == null && mPlaceholderDrawableResId != NO_PLACEHOLDER_DRAWABLE) {
            mPlaceholderIv = CHZZBannerUtil.getItemImageView(getContext(), mPlaceholderDrawableResId);
    ...
    public void setData(@DrawableRes int... resIds) {
        ...
        for (int resId : resIds) {
            views.add(CHZZBannerUtil.getItemImageView(getContext(), resId));
        }
        setData(views);
    }
    ...
    public CHZZViewPager getViewPager() {
        return mViewPager;
    }
    ...
    private void initViewPager() {
        ...
        mViewPager = new CHZZViewPager(getContext());
    ...
    public void setTransitionEffect(TransitionEffect effect) {
        ...
        if (mViewPager != null) {
            initViewPager();
            if (mHackyViews == null) {
                CHZZBannerUtil.resetPageTransformer(mViews);
            } else {
                CHZZBannerUtil.resetPageTransformer(mHackyViews);
            }
        }
    }
    ...
    private class PageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (mDelegate != null) {
                view.setOnClickListener(new CHZZOnNoDoubleClickListener() {
                    @Override
                    public void onNoDoubleClick(View view) {
                        int currentPosition = mViewPager.getCurrentItem() % mViews.size();
                        mDelegate.onBannerItemClick(CHZZBanner.this, view, mModels == null ? null : mModels.get(currentPosition), currentPosition);
                    }
                });
            }

            if (mAdapter != null) {
                mAdapter.fillBannerItem(CHZZBanner.this, view, mModels == null ? null : mModels.get(finalPosition), finalPosition);
            }
    ...
    private static class AutoPlayTask implements Runnable {
        private final WeakReference<CHZZBanner> mBanner;

        private AutoPlayTask(CHZZBanner banner) {
            mBanner = new WeakReference<>(banner);
        }

        @Override
        public void run() {
            CHZZBanner banner = mBanner.get();
            if (banner != null) {
    ...
    public interface Delegate<V extends View, M> {
        void onBannerItemClick(CHZZBanner banner, V itemView, M model, int position);
    }
    ...
    public interface Adapter<V extends View, M> {
        void fillBannerItem(CHZZBanner banner, V itemView, M model, int position);
    }
